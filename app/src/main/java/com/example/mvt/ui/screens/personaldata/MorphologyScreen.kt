...
fun MorphologyScreen(
    ...
    Scaffold(
        ...
        bottomBar = {
            MorphologyBottomBar(onSave = { guardarMorfologia() })
        }
    ) { innerPadding ->
        Box(
            modifier = Modifier
                ...
                MorphologySectionCard(
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            colors = morphologyEditableFieldColors()
                        )
                        OutlinedTextField(
                            value = peso,
                            onValueChange = {
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            modifier = Modifier.weight(1f),
                            shape = RoundedCornerShape(16.dp),
                            colors = morphologyReadOnlyFieldColors()
                        )
                    }
...
@Composable
private fun MorphologyBottomBar(onSave: () -> Unit) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        color = AppSurface,
...
@Composable
private fun morphologyEditableFieldColors() = OutlinedTextFieldDefaults.colors(
...
@Composable
private fun morphologyReadOnlyFieldColors() = OutlinedTextFieldDefaults.colors(
