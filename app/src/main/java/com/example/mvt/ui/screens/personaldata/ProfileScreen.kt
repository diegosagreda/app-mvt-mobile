            ...
            Column(
                ...
                ProfileSectionCard(
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            ProfileFieldLabel(text = "Nombres", required = true)
                        },
                        placeholder = { ProfilePlaceholder("Ingresa tus nombres") },
                        singleLine = true,
                        modifier = Modifier.fillMaxWidth(),
                        shape = RoundedCornerShape(16.dp),
                        colors = profileEditableFieldColors()
                    )
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            ProfileFieldLabel(text = "Apellidos", required = true)
                        },
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {},
                        label = {
                            ProfileFieldLabel(text = "Fecha de nacimiento", required = true)
                        },
                        ...
                        modifier = Modifier.fillMaxWidth(),
                        shape = RoundedCornerShape(16.dp),
                        colors = profileReadOnlyFieldColors()
                    )
                    ProfileFieldSpacer()
                    ...
                    OutlinedTextField(
                        ...
                        enabled = false,
                        label = {
                            ProfileFieldLabel(text = "Genero", required = true)
                        },
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            ...
                            label = {
                                ProfileFieldLabel(text = "Nacionalidad", required = true)
                            },
                ...
                ProfileSectionCard(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {},
                        label = {
                            ProfileFieldLabel(text = "Correo", required = true)
                        },
                        singleLine = true,
                        enabled = false,
                        modifier = Modifier.fillMaxWidth(),
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            ProfileFieldLabel(text = "Telefono", required = true)
                        },
...
@Composable
private fun ProfileBottomBar(onSave: () -> Unit) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        color = AppSurface,
...
@Composable
private fun profileEditableFieldColors() = OutlinedTextFieldDefaults.colors(
...
@Composable
private fun profileReadOnlyFieldColors() = OutlinedTextFieldDefaults.colors(
    focusedTextColor = AppTextSecondary,
